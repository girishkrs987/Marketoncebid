...
public class LoginStepDefinition {
	...
	public void title_of_login_page_is_free_Marketonce() {
...
////div[contains (text(),3305)]
		...
		// div[id='0-currentProjects-row']
			...
			for(int j=0;  j<=0; j++) {
				...
				//System.out.println("After search project ID" +"  "+FindingProjectID);
				//break;
				
				
				  if (FindingProjectID.contains(projid)) {
				  
				  System.out.println("After search project ID" +"  "+FindingProjectID); }
				  
				//Assert.assertEquals(FindingProjectID, projid);
